...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('balance', '100.00'); // Welcome bonus
  ...
  return (
    <div className="auth-page-container">
      ...
      <div className="auth-card register-card">
        ...
        <p className="auth-subtitle">Join GOLDEN88 and start winning today!</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="promo-banner">
            ...
            <div className="promo-text">
              ...
              <p>Get AUD 100 free credit on registration</p>
            </div>
          </div>
        ...
        <div className="social-login">
          <button
            ...
            onClick={() => alert('Facebook signup is coming soon! For now, please use the regular registration form.')}
          >
          ...
          <button
            ...
            onClick={() => alert('Google signup is coming soon! For now, please use the regular registration form.')}
          >
